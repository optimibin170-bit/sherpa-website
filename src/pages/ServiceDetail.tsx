          ...
          <article className="rounded-3xl border border-primary/15 bg-card/72 p-7 shadow-elevated backdrop-blur">
            ...
            <div className="mt-5 grid gap-3 sm:grid-cols-2">
              {service.deliverables.map((deliverable) => (
                (deliverable === "Custom app development" || deliverable === "Workflow automation" || deliverable === "Website and portal systems") ? (
                  <Link key={deliverable} to={deliverable === "Custom app development" ? "/custom-app-development" : deliverable === "Workflow automation" ? "/workflow-automation" : "/website-portal-systems"} className="flex items-center gap-3 font-bold text-ink-soft hover:text-primary transition-colors group">
